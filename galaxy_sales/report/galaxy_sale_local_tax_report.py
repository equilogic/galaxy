...
class galaxy_sale_local_tax_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(galaxy_sale_local_tax_report, self).__init__(cr, uid, name, context)
...
class report_print_local_tax_invoice_extended(models.AbstractModel):
    _name = 'report.galaxy_sales.report_galaxy_local_tax_invoice'
    _inherit = 'report.abstract_report'
    _template = 'galaxy_sales.report_galaxy_local_tax_invoice'
    _wrapped_report_class = galaxy_sale_local_tax_report